...
This is also where we run our filter specified in the configuration. This is
also where we decide to show/hide hidden windows. Namely, you can 'add' a
window to the tiling storage, and it's possible that it won't be added. That is
intentional.

If a window isn't in the storage, it will *not* be tiled. While
